...
public class MeasureTest_UsingUnitsFromOM extends TestCase {
	...
	public void test() throws SBOLGraphException, IOException
    {
        ...
        TestUtil.validateIdentifiedAndDocument(measure2,doc,0, null, null);
        ...
        TestUtil.validateIdentifiedAndDocument(measure2,doc,1, 1, "sbol3-10111", "measure2InvalidUnit_1");
        ...
        TestUtil.validateIdentifiedAndDocument(measure3,doc,1, null, "measure3NullUnit");
