...
public class ExternallyDefinedTest_11107 extends TestCase {
	...
	public void testSequenceFeature() throws SBOLGraphException, IOException, Exception {
		...
		TestUtil.validateIdentifiedAndDocument(exDefined, doc, 1, "sbol3-11107", "ExternallyDefined_types");
		...
		TestUtil.validateIdentifiedAndDocument(exDefined, doc, 1, "sbol3-11108", "ExternallyDefined_types_2");
	}
}
