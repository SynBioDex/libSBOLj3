...
public class ToggleSwitch_v2Test extends TestCase {

	public void testToggleSwitch_v2() throws SBOLGraphException, IOException
    {
        ...
        Component molecule1=SBOLAPI.createComponent(doc, SBOLAPI.append(baseUri, "molecule1"), ComponentType.Protein.getUri(), "Signalling Molecule 1", "Signalling Molecule 1", Role.TF);        
        Component molecule2=SBOLAPI.createComponent(doc, SBOLAPI.append(baseUri, "molecule2"), ComponentType.Protein.getUri(), "Signalling Molecule 2", "Signalling Molecule 2", Role.TF);
        SBOLAPI.addSubComponent(toggleSwitch, molecule1);//for LacI
        SBOLAPI.addSubComponent(toggleSwitch, molecule2);//for TetR
        SBOLAPI.addSubComponent(toggleSwitch, LacIProducer);
        SBOLAPI.addSubComponent(toggleSwitch, TetRProducer);
        
        
        SBOLAPI.mapTo(toggleSwitch, LacIProducer, LacI_protein, molecule1);
        SBOLAPI.mapTo(toggleSwitch, TetRProducer, LacI_protein, molecule1);
        SBOLAPI.mapTo(toggleSwitch, LacIProducer, TetR_protein, molecule2);
        SBOLAPI.mapTo(toggleSwitch, TetRProducer, TetR_protein, molecule2);
        ...
        TestUtil.serialise(doc2, "toggle_switch_v2", "toggle_switch_v2");     
